...
const CreatePintor = () => {
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    const { name, email, whatsappNumber,
      address, cpf, facebook, status,
      instagram, description } = formData;
    ...
    <>
      ...
      <div>
        <div className='bg-[#F59103] max-w[1344px] flex justify-between items-center'>
          <Link to="/"><img className='ml-[136px] my-4' src={logo} alt="" /></Link>
          <div className='mr-[299px]'>
            <Link to="/" className="inline-flex items-center px-4 py-2   text-[#2E2F7B] hover:text-white text-base font-bold ">
      ...
      <div id="page-create-point">
        ...
        <div className=" max-w[1344px] bg-[#F59103] flex justify-between items-center">
          <form onSubmit={handleSubmit} className=" mx-auto flex flex-col m-auto items-center  p-16 max-w[730px] bg-[#f3efef] rounded-lg ">
            ...
            <fieldset>
              ...
              <header role="legend">
                <h2 className="text-4xl text-[#2E2F7B]  font-bold">Enedereço</h2>
              </header>
              <div className="field-group">
                <div className="field">
              ...
              <header role="legend">
                <h2 className="text-4xl text-[#2E2F7B]  font-bold">Redes Sociais</h2>
              </header>
              <div className="field-group">
                <div className="field">
              ...
              <ul className="items-grid">
                {pinturas.map(pintura => (
                  <li
                    ...
                    className={selectedPinturas.includes(pintura.id) ? 'selected' : ''}>
                    <img className="rounded-md" src={pintura.photo} alt={pintura.name} />
                    <span className="text-xs items-center ">{pintura.name}</span>
                  </li>
                ))}
              </ul>
            </fieldset>
